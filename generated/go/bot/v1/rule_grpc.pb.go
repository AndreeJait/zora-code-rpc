...
const (
	RuleService_ListRules_FullMethodName  = "/bot.v1.RuleService/ListRules"
	RuleService_GetRule_FullMethodName    = "/bot.v1.RuleService/GetRule"
	RuleService_CreateRule_FullMethodName = "/bot.v1.RuleService/CreateRule"
	RuleService_UpdateRule_FullMethodName = "/bot.v1.RuleService/UpdateRule"
	RuleService_DeleteRule_FullMethodName = "/bot.v1.RuleService/DeleteRule"
)
...
type RuleServiceClient interface {
	...
	GetRule(ctx context.Context, in *GetRuleRequest, opts ...grpc.CallOption) (*BotRule, error)
	CreateRule(ctx context.Context, in *CreateRuleRequest, opts ...grpc.CallOption) (*BotRule, error)
	UpdateRule(ctx context.Context, in *UpdateRuleRequest, opts ...grpc.CallOption) (*BotRule, error)
	DeleteRule(ctx context.Context, in *DeleteRuleRequest, opts ...grpc.CallOption) (*v1.DeleteResponse, error)
}
...
func (c *ruleServiceClient) GetRule(ctx context.Context, in *GetRuleRequest, opts ...grpc.CallOption) (*BotRule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BotRule)
...
func (c *ruleServiceClient) CreateRule(ctx context.Context, in *CreateRuleRequest, opts ...grpc.CallOption) (*BotRule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BotRule)
...
func (c *ruleServiceClient) UpdateRule(ctx context.Context, in *UpdateRuleRequest, opts ...grpc.CallOption) (*BotRule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BotRule)
...
func (c *ruleServiceClient) DeleteRule(ctx context.Context, in *DeleteRuleRequest, opts ...grpc.CallOption) (*v1.DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RuleServiceServer interface {
	...
	GetRule(context.Context, *GetRuleRequest) (*BotRule, error)
	CreateRule(context.Context, *CreateRuleRequest) (*BotRule, error)
	UpdateRule(context.Context, *UpdateRuleRequest) (*BotRule, error)
	DeleteRule(context.Context, *DeleteRuleRequest) (*v1.DeleteResponse, error)
...
func (UnimplementedRuleServiceServer) GetRule(context.Context, *GetRuleRequest) (*BotRule, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRule not implemented")
}
func (UnimplementedRuleServiceServer) CreateRule(context.Context, *CreateRuleRequest) (*BotRule, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateRule not implemented")
}
func (UnimplementedRuleServiceServer) UpdateRule(context.Context, *UpdateRuleRequest) (*BotRule, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRule not implemented")
}
func (UnimplementedRuleServiceServer) DeleteRule(context.Context, *DeleteRuleRequest) (*v1.DeleteResponse, error) {
...
var RuleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bot.v1.RuleService",
