...
const (
	InferenceService_ListModels_FullMethodName  = "/model.v1.InferenceService/ListModels"
	InferenceService_HealthCheck_FullMethodName = "/model.v1.InferenceService/HealthCheck"
)
...
var InferenceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "model.v1.InferenceService",
	...
	Metadata: "model/v1/inference.proto",
}
